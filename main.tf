...
resource "rke_cluster" "this" {
  ...
  # https://www.terraform.io/docs/configuration/expressions.html#dynamic-blocks Effectively a for each loop.
  dynamic "nodes" {

    for_each = var.ec2_data # Only applicable to the multi-node configuration.
